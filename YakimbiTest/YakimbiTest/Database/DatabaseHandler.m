...
//        if (_manageObject && autorelease)
                return [_manageObject autorelease];
//        else
//            if (_manageObject) // this is intentionaly done
...
{
    SAFE_RELEASE(sharedObject);
}

- (void) dealloc
{
    SAFE_RELEASE(_storeCordinator);
    SAFE_RELEASE(_manageContext);
